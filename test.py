...
if __name__ == "__main__":
    ...
    data_dict = {'batch': batches.cuda(), 'feat': norms.flatten(end_dim=1).cuda().double(), 'coord': coords.flatten(end_dim=1)[:,0:3].cuda().double(), 'labels': labels.flatten().cuda().double(), 'grid_size': 0.001}
